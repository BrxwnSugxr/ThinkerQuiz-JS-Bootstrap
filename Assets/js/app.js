...
var questions = [
  {
    ...
    options: [
      'a) Styling web pages',
      'b) Enhancing interactivity on web pages',
  ...
  {
    title:
      'Which symbol is used for commenting out single-lines in JavaScript?',
    options: ['a) //', 'b) /*...*/', 'c) &&', 'd) ||'],
    answer: 'a) //',
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      'd) To remove an event from an element',
    ],
...
function questionClick(event) {
  ...
  } else if (buttonEl.value === correctAnswer) {
    answerCount++;
